...
export default function CustomerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <aside className="hidden md:flex flex-col w-60 shrink-0 gap-2">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5 text-center mb-2">
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = "/assets/images/faceless_profile.jpeg";
                }}
              />
      ...
      {/* Custom Cancel Order Confirmation Dialog */}
      {showCancelDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to cancel order #{showCancelDialog}? This
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => confirmCancelOrder(showCancelDialog)}
                disabled={cancellingOrderId === showCancelDialog}
                className="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {cancellingOrderId === showCancelDialog ? (
                  <>
