      ...
      if (Array.isArray(data)) {
        setOrders(
          data.map((o: Record<string, unknown>) => ({
            ...
            trackingNumber: (o.tracking_number || o.trackingNumber) as
              | string
              | undefined,
          })),
        );
  ...
  const fetchAnalytics = useCallback(async () => {
    ...
    try {
      ...
      setAnalytics({
        ...
        ordersByStatus:
          Array.isArray(data.ordersByStatus) && data.ordersByStatus.length > 0
        ...
        ordersPerUser:
          Array.isArray(data.ordersPerUser) && data.ordersPerUser.length > 0
            ? data.ordersPerUser
        ...
        <div className="p-5 border-b border-gray-800">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-black text-sm">
              ShopNova <span className="text-violet-400">Admin</span>
            </span>
          </div>
        </div>
            ...
            >
                ...
                {STAT_CARDS.map((card, i) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <span
                        className={`text-xs font-semibold flex items-center gap-0.5 ${card.up ? "text-green-600" : "text-red-500"}`}
                      >
                        {card.up ? (
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5">
                <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2">
                  <TrendingUp className="w-4 h-4 text-violet-600" /> Revenue
                  (Last 6 Months)
                </h3>
                  ...
                  <div className="space-y-3">
                    {topProducts.map((p, i) => (
                      <div key={i} className="flex items-center gap-3">
                        <span className="w-5 h-5 text-xs font-black text-gray-400 shrink-0 text-center">
                          #{i + 1}
                        </span>
                        <img
                          src={p.image}
                            ...
                            >
                              ...
                              <td className="px-5 py-4">
                                <div className="flex gap-2">
                                  <button
                                    onClick={() =>
                                      toast.info(`Order #${order.id} details`)
                                    }
                          ...
                          <div key={i} className="space-y-1.5">
                            ...
                            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                              <div
                                ...
                                style={{
                                  width: `${topProducts[0]?.sold ? (p.sold / topProducts[0].sold) * 100 : 0}%`,
                                }}
                              />
                            </div>
                          </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-5">
                      ...
                      <div className="space-y-3">
                        {ordersPerUser.map((u, i) => {
                          const displayName =
                            u.name ||
                            users.find((usr) => usr.id === String(u.userId))
                              ?.name ||
                            `User ${u.userId}`;
                          return (
                            <div key={i} className="flex items-center gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                                  <div
                                    ...
                                    style={{
                                      width: `${ordersPerUser[0]?.orders ? (u.orders / ordersPerUser[0].orders) * 100 : 0}%`,
                                    }}
                                  />
                                </div>
                              </div>
                      ...
                      {ordersByStatus.map((status, i) => (
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor: `${status.color || "#6b7280"}10`,
                          }}
                        >
                          <p
